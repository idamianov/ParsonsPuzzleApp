namespace ParsonsPuzzleApp.Constants
{
    /// <summary>
    /// Constants for LTI-related session keys.
    /// </summary>
    public static class LtiSessionKeys
    {
        public const string UserId = "LtiUserId";
        public const string UserName = "LtiUserName";
        public const string PlatformId = "LtiPlatformId";
